...
function Test()
{
    ...
    {   // Data is captured when the function getData() is executed
        ...
        setTimeout(() => {
            axios
                .get("http://localhost:8080/data") // Data Source
        ...
        <div>
            ...
            <div className="userlist">
...

                {
                    ...
                    <div className="beautify"> {/* A callback function loops over the state data */}
                        {/* <img src={capturedData.avatar_url}></img>    And Prints the Data */}
                        <h3>Username:{capturedData.name}</h3>
                        <h3>Email:{capturedData.email}</h3>
                    </div>)
                }
